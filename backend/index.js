...
function checkPayrollLimits(employer, amountUSD) {
  ...
  if (dailyUsed + amountUSD > dailyLimit) {
    return {
      ...
      limitType: 'daily',
      message: `You've reached your daily limit of $${dailyLimit.toLocaleString()}. Complete verification to increase your limits.`,
      remainingDailyUSD:   remDay,
      remainingMonthlyUSD: remMonth,
    };
  }
  ...
  if (monthlyUsed + amountUSD > monthlyLimit) {
    return {
      ...
      code: 'PAYROLL_LIMIT_EXCEEDED',
      limitType: 'monthly',
      message: `You've reached your monthly limit of $${monthlyLimit.toLocaleString()}. Complete verification to increase your limits.`,
      remainingDailyUSD:   remDay,
      remainingMonthlyUSD: remMonth,
    };
  }
